...
FLINT_DLL void _eval_to_bpoly(n_bpoly_t E, const nmod_mpoly_t A,
                 const n_poly_struct * alphabetas, const nmod_mpoly_ctx_t ctx);

FLINT_DLL void _nmod_mpoly_set_bpoly_var1_zero(nmod_mpoly_t A, 
