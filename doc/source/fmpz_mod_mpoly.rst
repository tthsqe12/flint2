...
**fmpz_mod_mpoly.h** -- polynomials over integers mod n
===============================================================================
...
.. function:: void fmpz_mod_mpoly_ctx_clear(fmpz_mod_mpoly_ctx_t ctx)
    ...
    Release up any space allocated by an ``fmpz_mod_mpoly_ctx_t``.
...
.. function:: int _fmpz_mod_mpoly_fits_small(const fmpz * poly, slong len)
...
.. function:: slong fmpz_mod_mpoly_max_bits(const fmpz_mod_mpoly_t A)
...
.. function:: void fmpz_mod_mpoly_set_coeff_fmpz_monomial(fmpz_mod_mpoly_t poly, const fmpz_t c, const fmpz_mod_mpoly_t poly2, const fmpz_mod_mpoly_ctx_t ctx)
...
.. function:: void fmpz_mod_mpoly_get_coeff_fmpz_fmpz(fmpz_t c, const fmpz_mod_mpoly_t A, fmpz * const * exp, const fmpz_mod_mpoly_ctx_t ctx)
              ulong fmpz_mod_mpoly_get_coeff_ui_fmpz(const fmpz_mod_mpoly_t A, fmpz * const * exp, const fmpz_mod_mpoly_ctx_t ctx)
              slong fmpz_mod_mpoly_get_coeff_si_fmpz(const fmpz_mod_mpoly_t A, fmpz * const * exp, const fmpz_mod_mpoly_ctx_t ctx)
              void fmpz_mod_mpoly_get_coeff_fmpz_ui(fmpz_t c, const fmpz_mod_mpoly_t A, ulong const * exp, const fmpz_mod_mpoly_ctx_t ctx)
              ulong fmpz_mod_mpoly_get_coeff_ui_ui(const fmpz_mod_mpoly_t A, ulong const * exp, const fmpz_mod_mpoly_ctx_t ctx)
              slong fmpz_mod_mpoly_get_coeff_si_ui(const fmpz_mod_mpoly_t A, ulong const * exp, const fmpz_mod_mpoly_ctx_t ctx)
...
.. function:: void fmpz_mod_mpoly_set_coeff_si_ui(fmpz_mod_mpoly_t A, slong c, ulong const * exp, const fmpz_mod_mpoly_ctx_t ctx)
...
.. function:: fmpz * fmpz_mod_mpoly_term_coeff_ref(fmpz_mod_mpoly_t A, slong i, const fmpz_mod_mpoly_ctx_t ctx)
...
.. function:: void fmpz_mod_mpoly_get_term_coeff_fmpz(fmpz_t c, const fmpz_mod_mpoly_t A, slong i, const fmpz_mod_mpoly_ctx_t ctx)
              ulong fmpz_mod_mpoly_get_term_coeff_ui(const fmpz_mod_mpoly_t A, slong i, const fmpz_mod_mpoly_ctx_t ctx)
              slong fmpz_mod_mpoly_get_term_coeff_si(const fmpz_mod_mpoly_t poly, slong i, const fmpz_mod_mpoly_ctx_t ctx)
...
.. function:: void fmpz_mod_mpoly_randtest_bound(fmpz_mod_mpoly_t A, flint_rand_t state, slong length, mp_limb_t coeff_bits, ulong exp_bound, const fmpz_mod_mpoly_ctx_t ctx)
...
.. function:: void fmpz_mod_mpoly_randtest_bounds(fmpz_mod_mpoly_t A, flint_rand_t state, slong length, mp_limb_t coeff_bits, ulong * exp_bounds, const fmpz_mod_mpoly_ctx_t ctx)
...
.. function:: void fmpz_mod_mpoly_randtest_bits(fmpz_mod_mpoly_t A, flint_rand_t state, slong length, mp_limb_t coeff_bits, mp_limb_t exp_bits, const fmpz_mod_mpoly_ctx_t ctx)
    ...
    The parameter ``coeff_bits`` to the three functions ``fmpz_mod_mpoly_randtest_{bound|bounds|bits}`` is merely a suggestion for the approximate bit count of the resulting signed coefficients.
    The function :func:`fmpz_mod_mpoly_max_bits` will give the exact bit count of the result.
...
.. function:: void fmpz_mod_mpoly_scalar_fmma(fmpz_mod_mpoly_t A, const fmpz_mod_mpoly_t B, const fmpz_t c, const fmpz_mod_mpoly_t D, const fmpz_t e, const fmpz_mod_mpoly_ctx_t ctx)

    Sets `A` to `B \times c + D \times e`.

.. function:: void fmpz_mod_mpoly_scalar_divexact_fmpz(fmpz_mod_mpoly_t A, const fmpz_mod_mpoly_t B, const fmpz_t c, const fmpz_mod_mpoly_ctx_t ctx)
              void fmpz_mod_mpoly_scalar_divexact_ui(fmpz_mod_mpoly_t A, const fmpz_mod_mpoly_t B, ulong c, const fmpz_mod_mpoly_ctx_t ctx)
              void fmpz_mod_mpoly_scalar_divexact_si(fmpz_mod_mpoly_t A, const fmpz_mod_mpoly_t B, slong c, const fmpz_mod_mpoly_ctx_t ctx)

    Set `A` to `B` divided by `c`. The division is assumed to be exact.

.. function:: int fmpz_mod_mpoly_scalar_divides_fmpz(fmpz_mod_mpoly_t A, const fmpz_mod_mpoly_t B, const fmpz_t c, const fmpz_mod_mpoly_ctx_t ctx)
              int fmpz_mod_mpoly_scalar_divides_ui(fmpz_mod_mpoly_t A, const fmpz_mod_mpoly_t B, ulong c, const fmpz_mod_mpoly_ctx_t ctx)
              int fmpz_mod_mpoly_scalar_divides_si(fmpz_mod_mpoly_t A, const fmpz_mod_mpoly_t B, slong c, const fmpz_mod_mpoly_ctx_t ctx)
...
.. function:: void fmpz_mod_mpoly_integral(fmpz_mod_mpoly_t A, fmpz_t scale, const fmpz_mod_mpoly_t B, slong var, const fmpz_mod_mpoly_ctx_t ctx)
...
.. function:: int fmpz_mod_mpoly_evaluate_all_fmpz(fmpz_t ev, const fmpz_mod_mpoly_t A, fmpz * const * vals, const fmpz_mod_mpoly_ctx_t ctx)

    Set ``ev`` to the evaluation of ``A`` where the variables are replaced by the corresponding elements of the array ``vals``.
    Return `1` for success and `0` for failure.

.. function:: int fmpz_mod_mpoly_evaluate_one_fmpz(fmpz_mod_mpoly_t A, const fmpz_mod_mpoly_t B, slong var, const fmpz_t val, const fmpz_mod_mpoly_ctx_t ctx)
...
.. function:: void fmpz_mod_mpoly_mul(fmpz_mod_mpoly_t A, const fmpz_mod_mpoly_t B, const fmpz_mod_mpoly_t C, const fmpz_mod_mpoly_ctx_t ctx)
              void fmpz_mod_mpoly_mul_threaded(fmpz_mod_mpoly_t A, const fmpz_mod_mpoly_t B, const fmpz_mod_mpoly_t C, const fmpz_mod_mpoly_ctx_t ctx, slong thread_limit)
...
.. function:: void fmpz_mod_mpoly_mul_johnson(fmpz_mod_mpoly_t A, const fmpz_mod_mpoly_t B, const fmpz_mod_mpoly_t C, const fmpz_mod_mpoly_ctx_t ctx)
              void fmpz_mod_mpoly_mul_heap_threaded(fmpz_mod_mpoly_t A, const fmpz_mod_mpoly_t B, const fmpz_mod_mpoly_t C, const fmpz_mod_mpoly_ctx_t ctx)

    Set ``A`` to ``B`` times ``C`` using Johnson's heap-based method.
    The first version always uses one thread.

.. function:: int fmpz_mod_mpoly_mul_array(fmpz_mod_mpoly_t A, const fmpz_mod_mpoly_t B, const fmpz_mod_mpoly_t C, const fmpz_mod_mpoly_ctx_t ctx)
              int fmpz_mod_mpoly_mul_array_threaded(fmpz_mod_mpoly_t A, const fmpz_mod_mpoly_t B, const fmpz_mod_mpoly_t C, const fmpz_mod_mpoly_ctx_t ctx)
...
.. function:: void fmpz_mod_mpoly_quasidivrem(fmpz_t scale, fmpz_mod_mpoly_t Q, fmpz_mod_mpoly_t R, const fmpz_mod_mpoly_t A, const fmpz_mod_mpoly_t B, const fmpz_mod_mpoly_ctx_t ctx)
...
.. function:: void fmpz_mod_mpoly_div(fmpz_mod_mpoly_t Q, const fmpz_mod_mpoly_t A, const fmpz_mod_mpoly_t B, const fmpz_mod_mpoly_ctx_t ctx)
    ...
    Perform the operation of :func:`fmpz_mod_mpoly_divrem` and discard ``R``.
    Note that this function is not very useful if the division is not exact and the leading coefficient ``B`` is not a unit.

.. function:: void fmpz_mod_mpoly_quasidiv(fmpz_t scale, fmpz_mod_mpoly_t Q, const fmpz_mod_mpoly_t A, const fmpz_mod_mpoly_t B, const fmpz_mod_mpoly_ctx_t ctx)

    Perform the operation of :func:`fmpz_mod_mpoly_quasidivrem` and discard ``R``.
...
.. function:: void fmpz_mod_mpoly_quasidivrem_ideal(fmpz_t scale, fmpz_mod_mpoly_struct ** Q, fmpz_mod_mpoly_t R, const fmpz_mod_mpoly_t A, fmpz_mod_mpoly_struct * const * B, slong len, const fmpz_mod_mpoly_ctx_t ctx)

    This function is as per :func:`fmpz_mod_mpoly_quasidivrem` except that it takes an array of divisor polynomials ``B`` and it returns an array of quotient polynomials ``Q``.
    The number of divisor (and hence quotient) polynomials, is given by ``len``.
