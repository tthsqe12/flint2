...
choose_prime: /* primes are v - alpha, v + alpha */
    ...
    if (nmod_poly_degree(modulus) > 0)
    {
        ...
        if (!gstab)
        {
            gstab = !nmod_mpolyn_intp_crt_2sm_poly(&ldegG, G, T,
                                       Gevalp, Gevalm, modulus, alphapow, ctx);
        }
        nmod_mpolyn_intp_crt_2sm_poly(&ldegAbar, Abar, T,
                                 Abarevalp, Abarevalm, modulus, alphapow, ctx);
        nmod_mpolyn_intp_crt_2sm_poly(&ldegBbar, Bbar, T,
                                 Bbarevalp, Bbarevalm, modulus, alphapow, ctx);
    }
    else
    {
        nmod_mpolyn_intp_lift_2sm_poly(&ldegG, G, Gevalp, Gevalm, alpha, ctx);
        nmod_mpolyn_intp_lift_2sm_poly(&ldegAbar, Abar,
                                             Abarevalp, Abarevalm, alpha, ctx);
        nmod_mpolyn_intp_lift_2sm_poly(&ldegBbar, Bbar,
...
choose_prime:
    ...
    if (nmod_poly_degree(modulus) > 0)
    {
        ...
        changed = new_nmod_mpolyn_intp_crt_2sm_mpolyn(&ldegG, G, T1,
...
successful_fix_lc:
        ...
        changed = new_nmod_mpolyn_intp_crt_2sm_mpolyn(&ldegAbar, Abar, T1,
        ...
        changed = new_nmod_mpolyn_intp_crt_2sm_mpolyn(&ldegBbar, Bbar, T1,
    ...
    {
        new_nmod_mpolyn_intp_lift_2sm_mpolyn(&ldegG, G,
                                              Gevalp, Gevalm, var, alpha, ctx);
        new_nmod_mpolyn_intp_lift_2sm_mpolyn(&ldegAbar, Abar,
                                        Abarevalp, Abarevalm, var, alpha, ctx);
        new_nmod_mpolyn_intp_lift_2sm_mpolyn(&ldegBbar, Bbar,
...
have_prime:
    ...
    if (nmod_poly_degree(modulus) > 0)
    {
        nmod_mpolyn_intp_crt_lg_poly(&ldegG, G, T, modulus, ctx,
                                                           Geval, ectx->fqctx);
        nmod_mpolyn_intp_crt_lg_poly(&ldegAbar, Abar, T, modulus, ctx,
                                                        Abareval, ectx->fqctx);
        nmod_mpolyn_intp_crt_lg_poly(&ldegBbar, Bbar, T, modulus, ctx,
                                                        Bbareval, ectx->fqctx);
    }
    else
    {
        nmod_mpolyn_intp_lift_lg_poly(&ldegG, G, ctx, Geval, ectx->fqctx);
        nmod_mpolyn_intp_lift_lg_poly(&ldegAbar, Abar, ctx,
                                                        Abareval, ectx->fqctx);
        nmod_mpolyn_intp_lift_lg_poly(&ldegBbar, Bbar, ctx,
                                                        Bbareval, ectx->fqctx);
    }
...
have_prime:
    ...
    if (nmod_poly_degree(modulus) > 0)
    {
        new_nmod_mpolyn_intp_crt_lg_mpolyn(&ldegG, G, T, modulus,
                                                        var, ctx, Geval, ectx);
        new_nmod_mpolyn_intp_crt_lg_mpolyn(&ldegAbar, Abar, T, modulus,
                                                     var, ctx, Abareval, ectx);
        new_nmod_mpolyn_intp_crt_lg_mpolyn(&ldegBbar, Bbar, T, modulus,
                                                     var, ctx, Bbareval, ectx);
    }
    else
    {
        new_nmod_mpolyn_intp_lift_lg_mpolyn(&ldegG, G, var, ctx, Geval, ectx);
        new_nmod_mpolyn_intp_lift_lg_mpolyn(&ldegAbar, Abar,
                                                     var, ctx, Abareval, ectx);
        new_nmod_mpolyn_intp_lift_lg_mpolyn(&ldegBbar, Bbar,
                                                     var, ctx, Bbareval, ectx);
    }
    nmod_poly_mul(modulus, modulus, ectx->fqctx->modulus);
