...
FLINT_DLL void _fmpz_mod_poly_vec_remove_content(
    fmpz_mod_poly_t g,
    fmpz_mod_poly_struct * A,
    slong Alen,
    const fmpz_mod_ctx_t ctx);

FLINT_DLL void _fmpz_mod_poly_vec_mul_poly(
    fmpz_mod_poly_struct * A,
    slong Alen,
    const fmpz_mod_poly_t g,
    const fmpz_mod_ctx_t ctx);

FLINT_DLL void _fmpz_mod_poly_vec_divexact_poly(
    fmpz_mod_poly_struct * A,
    slong Alen,
    const fmpz_mod_poly_t g,
    const fmpz_mod_ctx_t ctx);

FLINT_DLL void _fmpz_mod_poly_vec_mul_fmpz_mod(
    fmpz_mod_poly_struct * A,
    slong Alen,
    const fmpz_t g,
    const fmpz_mod_ctx_t ctx);
...
FLINT_DLL void fmpz_mod_bma_mpoly_add_point(
...
FLINT_DLL void fmpz_mod_mpolyuu_use_skel_mul(
    fmpz_mod_polyun_t E,
...
FLINT_DLL void fmpz_mpolyuu_eval_fmpz_mod(
    fmpz_mod_polyun_t E,
    const fmpz_mod_ctx_t ctx_mp,
    const fmpz_mpolyu_t A,
    const fmpz * alpha,
