...
main(void)
{
    ...
    for (i = 0; i < 10 * flint_test_multiplier(); i++)
    {
        ...
        for (j = 0; j < 1; j++)
        {
            ...
            fmpq_mpoly_add(h, g, f, ctx);
            fmpq_mpoly_sub(k, h, g, ctx);
    ...
    for (i = 0; i < 10 * flint_test_multiplier(); i++)
    {
        ...
        for (j = 0; j < 10; j++)
        {
            ...
            fmpq_mpoly_sub(h, f, g, ctx);
            fmpq_mpoly_neg(k, g, ctx);
            fmpq_mpoly_add(k, k, f, ctx);
            result = fmpq_mpoly_equal(h, k, ctx);
    ...
    for (i = 0; i < 10 * flint_test_multiplier(); i++)
    {
        ...
        for (j = 0; j < 4; j++)
        {
            ...
            fmpq_mpoly_add(k1, f, g, ctx);
            fmpq_mpoly_add(k1, k1, h, ctx);
            fmpq_mpoly_add(k2, g, h, ctx);
            fmpq_mpoly_add(k2, k2, f, ctx);
    ...
    for (i = 0; i < 10 * flint_test_multiplier(); i++)
    {
        ...
        for (j = 0; j < 4; j++)
        {
            ...
            fmpq_mpoly_add(k1, g, h, ctx);
            fmpq_mpoly_sub(k1, f, k1, ctx);
            fmpq_mpoly_sub(k2, f, g, ctx);
            fmpq_mpoly_sub(k2, k2, h, ctx);
            result = fmpq_mpoly_equal(k1, k2, ctx);
    ...
    for (i = 0; i < 50 * flint_test_multiplier(); i++)
    {
        ...
        for (j = 0; j < 4; j++)
        {
            ...
            if ((j % 2) == 0)
            {
                ...
                fmpq_mpoly_add(f, g, f, ctx);
                fmpq_mpoly_assert_canonical(f, ctx);
            }
            else
            {
                fmpq_mpoly_sub(h, g, f, ctx);
                fmpq_mpoly_assert_canonical(h, ctx);
                fmpq_mpoly_sub(f, g, f, ctx);
                fmpq_mpoly_assert_canonical(f, ctx);
            }
            ...
            if ((j % 2) == 0)
            {
                fmpq_mpoly_add(h, f, f, ctx);
                fmpq_mpoly_assert_canonical(h, ctx);
                fmpq_mpoly_add(f, f, f, ctx);
                fmpq_mpoly_assert_canonical(f, ctx);
            }
            else
            {
                fmpq_mpoly_sub(h, f, f, ctx);
                fmpq_mpoly_assert_canonical(h, ctx);
                fmpq_mpoly_sub(f, f, f, ctx);
                fmpq_mpoly_assert_canonical(f, ctx);
            }
            result = fmpq_mpoly_equal(f, h, ctx);
