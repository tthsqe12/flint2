...
void 
fmpz_mod_poly_xgcd_euclidean(fmpz_mod_poly_t G, fmpz_mod_poly_t S,
                             ...
                             const fmpz_mod_poly_t B, const fmpz_mod_ctx_t ctx)
{
    ...
    else  /* lenA >= lenB >= 0 */
    {
        ...
        {
            fmpz_invmod(inv, fmpz_mod_poly_lead(A), fmpz_mod_ctx_modulus(ctx));
        ...
        else  /* lenA >= lenB >= 1 */
        {
            ...
            fmpz_invmod(inv, fmpz_mod_poly_lead(B), fmpz_mod_ctx_modulus(ctx));
            lenG = _fmpz_mod_poly_xgcd_euclidean(g, s, t, A->coeffs, lenA,
