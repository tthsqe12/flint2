...
{
    fmpz_mod_poly_init(B->V0);
    fmpz_mod_poly_init(B->R0);
    fmpz_mod_poly_set_ui(B->R0, 1, ctx);
    fmpz_mod_poly_init(B->V1);
    fmpz_mod_poly_set_ui(B->V1, 1, ctx);
    fmpz_mod_poly_init(B->R1);
    fmpz_mod_poly_init(B->rt);
    fmpz_mod_poly_init(B->qt);
    fmpz_mod_poly_init(B->points);
    B->npoints = 0;
    B->points->length = 0;
}
