         ...
         flint_rand_t state, const fmpz_mod_poly_t f, const fmpz_mod_ctx_t ctx)
{
    ...
    fmpz_mod_poly_init(x);
    fmpz_mod_poly_init(x_p);
    ...
    fmpz_mod_poly_init(x_pi);
    fmpz_mod_poly_init(x_pi2);
    ...
    else
    {
        ...
        fmpz_mod_poly_init(factor);
        fmpz_mod_poly_init(b);
        fmpz_mod_poly_init(power);
