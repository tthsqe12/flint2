...
choose_prime:
    ...
    fmpz_mpoly_intp_reduce_p_mpolyn(Ap, pctx, A, ctx);
    fmpz_mpoly_intp_reduce_p_mpolyn(Bp, pctx, B, ctx);
    ...
    if (!fmpz_is_one(modulus))
    {
        new_fmpz_mpoly_intp_crt_p_mpolyn(G, T, ctx, modulus, Gp, pctx);
        new_fmpz_mpoly_intp_crt_p_mpolyn(Abar, T, ctx, modulus, Abarp, pctx);
        new_fmpz_mpoly_intp_crt_p_mpolyn(Bbar, T, ctx, modulus, Bbarp, pctx);
    }
    else
    {
